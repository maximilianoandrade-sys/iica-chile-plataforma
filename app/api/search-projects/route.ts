...
//
// Endpoint de búsqueda IICA Chile.
// Lectura directa de Supabase + Mercado Público live en paralelo.
// Sin Claude runtime (eso fue eliminado: ahora hay scrapers diarios
// que llenan la BD vía GitHub Actions, ver lib/ingestion/).
//
// Body:
//   { query?, scope?, role?, includeUnverified? }
//
// Response:
//   { results: Project[], meta: { total, db_count, mercado_publico_count, ... } }
// ============================================================
