...
export default function PrivacyPolicyPage() {
    return (
        <main className="container mx-auto px-4 py-12 max-w-4xl text-gray-700 leading-relaxed space-y-8">
            ...
            <section className="space-y-4">
                <h2 className="text-2xl font-bold text-[var(--iica-blue)]">3. Cookies y Tecnologías Similares</h2>
                <p>
            ...
            <section className="space-y-4">
                <h2 className="text-2xl font-bold text-[var(--iica-blue)]">4. Seguridad de la Información</h2>
                <p>
            ...
            <section className="space-y-4">
                ...
                <p className="font-medium">
                    IICA Chile<br />
                    Correo electrónico: representacion.chile@iica.int<br />
