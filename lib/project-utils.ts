...
// Tipos y formateadores puros y seguros para cliente y servidor.
// Sin dependencias de base de datos ni archivos JSON masivos.
// ============================================================================
...
// ============================================================================
// HELPERS DE FORMATEO Y DOMINIO AGRÍCOLA
// ============================================================================
...
export function formatDeadline(date: Date | string | null | undefined): string {
    ...
    return new Date(date!).toLocaleDateString('es-CL', {
        timeZone: 'UTC',  // Las fechas se almacenan a mediodía UTC para estabilidad cross-timezone.
    });
}

/** Calcula días hasta cierre (negativo = ya cerró, 999 = sin fecha definida) */
