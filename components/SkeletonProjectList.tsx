        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-[var(--iica-border)] overflow-hidden animate-pulse">
            ...
            <div className="hidden md:block">
                <table className="w-full">
                    <thead>
                        <tr className="bg-[var(--iica-gray)] border-b border-[var(--iica-border)]">
                            <th className="py-5 px-6"><div className="h-4 w-24 bg-gray-200 dark:bg-gray-700 rounded"></div></th>
                            <th className="py-5 px-6"><div className="h-4 w-24 bg-gray-200 dark:bg-gray-700 rounded"></div></th>
                            <th className="py-5 px-6"><div className="h-4 w-24 bg-gray-200 dark:bg-gray-700 rounded"></div></th>
                            <th className="py-5 px-6"><div className="h-4 w-24 bg-gray-200 dark:bg-gray-700 rounded ml-auto"></div></th>
                        </tr>
                    </thead>
                        ...
                        {[...Array(5)].map((_, i) => (
                            <tr key={i}>
                                ...
                                <td className="py-5 px-6 text-right">
                                    <div className="h-9 w-32 bg-gray-200 dark:bg-gray-700 rounded ml-auto"></div>
                                </td>
                            </tr>
                        ))}
                    </tbody>
