                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-white/60 uppercase tracking-widest font-medium">Radar de Oportunidades · IICA Chile</p>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-3">
                            <a
                                ...
                                className="w-11 h-11 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors"
                                aria-label="LinkedIn de IICA Chile (abre en nueva pestaña)"
                            >
                            ...
                            <a
                                ...
                                rel="noopener noreferrer"
                                className="w-11 h-11 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors"
                                aria-label="X (Twitter) de IICA Chile (abre en nueva pestaña)"
                            >
